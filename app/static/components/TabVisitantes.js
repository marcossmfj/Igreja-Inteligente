export default {
    props: ['members'],
    emits: ['export-pdf', 'show-modal-add-visitor', 'open-promotion'],
    data() {
        return {
            searchTerm: ''
        }
                ...
                <div class="space-y-6">
                    <div class="flex justify-between items-center mb-10">
                        <div class="flex items-center gap-6">
                            <h2 class="text-5xl font-black tracking-tight text-slate-900">Visitantes Recentes</h2>
                        ...
                        <div class="flex gap-3">
                            ...
                            <button @click="$emit('show-modal-add-visitor')" class="bg-emerald-500 text-white px-8 py-4 rounded-2xl font-black shadow-lg">Novo Visitante +</button>
                        </div>
                    </div>
                            ...
                            <tbody class="divide-y divide-slate-50">
                                <tr v-for="m in filteredMembers" :key="m.id" class="hover:bg-indigo-50/20 transition-colors group">
                                    ...
                                    <td class="p-4 text-right">
                                        <button @click="$emit('open-promotion', m)" class="bg-indigo-600 text-white px-4 py-2 rounded-lg font-black text-[10px] hover:bg-indigo-700 transition-all shadow-md">Promover</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
